...
$Experience = [
  ...
  'date' => ['Jan 2015 -','Current', 'Mar 2012 - Dec 2014', 'Jun 2010 - Mar 2012'],
  'information' => [
      ...
      <div class="w3-third">
        ...
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-user fa-fw w3-margin-right w3-large w3-text-teal"></i>Возраст:<?php echo $age; ?><br>
            <p><i class="fa fa-user-secret fa-fw w3-margin-right w3-large w3-text-teal"></i>Возраст в днях: <?php echo $ageInDays; ?>
            ...
            <?php foreach ($skils as $skillName => $skillValue) : ?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right">
              </i><?php echo $Experience['date'][0]?> <span class="w3-tag w3-teal w3-round">
                <?php echo $Experience['date'][1]?></span></h6>
            <p><?php echo $Experience['information'][0]?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $Experience['post'][1]?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right">
              </i><?php echo $Experience['date'][2]?></h6>
            <p><?php echo $Experience['information'][1]?></p>
            <hr>
          </div>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $Experience['post'][2]?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right">
              </i><?php echo $Experience['date'][3]?></h6>
            <p><?php echo $Experience['information'][2]?> </p><br>
          </div>
        </div>
